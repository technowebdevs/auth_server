package com.technoweb.authserver.filters;

import com.technoweb.authserver.constants.SecurityConstants;
...
public class JwtTokenGenerationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(null != authentication){
            ...
            String jwt = Jwts.builder().setIssuer("TechnoWeb").setSubject("JWT Token")
